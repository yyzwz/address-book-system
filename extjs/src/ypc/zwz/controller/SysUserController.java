 ...
 * 	用于   用户登入模块的 Controller
 */

@Controller
@RequestMapping("/sys/sysuser")
public class SysUserController extends ForestryBaseController<SysUser> {

	/**
	 * 	Spring自动注入服务层Service
	 */
	@Resource
	 ...
	 * @param code          验证码
	 * 
	 * @return  登入成功进入loginExt页面  || 登入失败返回loginFail页面
	 */
    @RequestMapping(value = "/login")
    public String login(@RequestParam String a_name, @RequestParam String a_password,@RequestParam String code,
	...
	public void logout(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.sendRedirect("/ZwzTelSystem/loginExt.jsp");
	}
