...
<div class="search">
    <Card>
        ...
        <Row type="flex" justify="end" class="page">
            <Page :current="searchForm.pageNumber" :total="total" :page-size="searchForm.pageSize" @on-change="changePage" @on-page-size-change="changePageSize" :page-size-opts="[10,15,20,50]" size="small" show-total show-elevator show-sizer></Page>
        </Row>
    </Card>
    ...
    <Modal :title="modalTitle" v-model="permModalVisible" :mask="false" draggable ok-text="保存菜单权限" @on-ok="submitPermEdit" @on-cancel="cancelPermEdit">
        <Row :gutter="16">
            <Col span="24" style="overflow-y: scroll;max-height: 560px">
