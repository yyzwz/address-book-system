            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="通话人" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="mobile">
                        <Input type="text" v-model="searchForm.mobile" placeholder="通话手机" clearable style="width: 120px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getCallRecordList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
