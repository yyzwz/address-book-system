            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="姓名" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="userSex">
                        <Select v-model="searchForm.userSex" clearable style="width:120px">
                            <Option value="男">男</Option>
                            <Option value="女">女</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="mobile">
                        <Input type="text" v-model="searchForm.mobile" placeholder="手机" clearable style="width: 120px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getTelDataList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
