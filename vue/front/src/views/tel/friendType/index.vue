            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="朋友类型" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="level">
                        <Select v-model="searchForm.level" placeholder="重要程度" clearable style="width: 200px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getFriendTypeList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
