...
public class MyBatisPlusCodeUtils {
    ...
    private static final String className = "CallRecord";

    @ApiModelProperty(value = "类备注")
    private static final String description = "通话记录";
    ...
    private static final String entityPackage = "cn.zwz.tel.entity";

    @ApiModelProperty(value = "dao对应包")
    private static final String daoPackage = "cn.zwz.tel.mapper";

    @ApiModelProperty(value = "service对应包")
    private static final String servicePackage = "cn.zwz.tel.service";

    @ApiModelProperty(value = "serviceImpl对应包")
    private static final String serviceImplPackage = "cn.zwz.tel.serviceimpl";

    @ApiModelProperty(value = "controller对应包")
    private static final String controllerPackage = "cn.zwz.tel.controller";
