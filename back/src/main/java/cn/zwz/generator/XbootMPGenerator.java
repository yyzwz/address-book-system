...
import static cn.zwz.generator.XbootGenerator.*;
...
public class XbootMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String DESCRIPTION = "通讯录";
     ...
     * (文件自动生成至该包下)
     */
    private static final String ENTITY_PACKAGE = "cn.zwz.modules.tel.entity";

    /**
     * dao对应包 【注意修改后需到cn.zwz.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String DAO_PACKAGE = "cn.zwz.modules.tel.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_PACKAGE = "cn.zwz.modules.tel.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_IMPL_PACKAGE = "cn.zwz.modules.tel.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String CONTROLLER_PACKAGE = "cn.zwz.modules.tel.controller";
