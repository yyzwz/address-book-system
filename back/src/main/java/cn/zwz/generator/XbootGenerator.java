...
public class XbootGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String ENTITY_PACKAGE = "cn.zwz.modules.your.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String DAO_PACKAGE = "cn.zwz.modules.your.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_PACKAGE = "cn.zwz.modules.your.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_IMPL_PACKAGE = "cn.zwz.modules.your.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String CONTROLLER_PACKAGE = "cn.zwz.modules.your.controller";
